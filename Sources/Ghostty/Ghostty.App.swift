...
extension Ghostty {
    ...
    class App: ObservableObject {
...
#if os(macOS)
            // MONTTY: Guard against NSApp being nil during early init
            // (AppDelegate.init runs before NSApplication is fully set up)
        ...
        // MONTTY: Stubbed -- FullscreenMode type not copied. Can add later.
        ...
        // MONTTY: Stubbed -- no TerminalWindow type. Can add float-on-top later.
        ...
        // MONTTY: Stubbed -- no BaseTerminalController. Can add later.
        ...
        private static func setTabTitle(
            ...
            // MONTTY: Stubbed -- no BaseTerminalController. Will route through TabStore in Phase 2.
            case GHOSTTY_TARGET_SURFACE:
                return false
