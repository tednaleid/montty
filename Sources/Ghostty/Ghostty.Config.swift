...
extension Ghostty {
    ...
    class Config: ObservableObject {
        ...
        // MONTTY: Removed windowFullscreen and windowFullscreenMode properties
        // that referenced FullscreenMode type (not copied). Can add back if needed.
...
#error("unsupported")
        ...
        // MONTTY: Removed quickTerminal* config properties that referenced
        // QuickTerminalPosition, QuickTerminalScreen, QuickTerminalSpaceBehavior,
        // QuickTerminalSize types (not copied). montty is not a quick terminal.
