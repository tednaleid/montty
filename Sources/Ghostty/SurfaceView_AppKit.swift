...
extension Ghostty {
    ...
    class SurfaceView: OSView, ObservableObject, Codable, Identifiable {
        ...
        // MONTTY: Removed inspector computed property (Inspector not copied)
        // MONTTY: Removed inspectorVisible published property (Inspector not copied)
        ...
        override func mouseMoved(with event: NSEvent) {
            ...
            // MONTTY: Removed focus-follows-mouse (referenced BaseTerminalController)
        }
        ...
        override func menu(for event: NSEvent) -> NSMenu? {
            ...
            // MONTTY: Removed "Toggle Terminal Inspector" context menu item (Inspector not copied)
            ...
            menu.addItem(.separator())
            // MONTTY: Removed "Change Tab Title..." menu item (referenced BaseTerminalController)
        ...
        // MONTTY: Removed toggleTerminalInspector @objc method (Inspector not copied)
