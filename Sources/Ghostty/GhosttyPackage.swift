...
// MONTTY: Removed SplitFocusDirection.toSplitTreeFocusDirection() extension
// that referenced SplitTree type from Ghostty's app layer. Will be replaced
// by montty's own split tree in Phase 3.
